...
I build backend systems, real-time applications, and experimental platforms — focusing on turning constraints into features.

Started coding at 14, and since then I’ve been designing and deploying projects ranging from real-time polling systems to blockchain simulations.<br><br>
<p align='center'>
...
- **Machine Learning & AI:** Hands-on experience with **PyTorch and TensorFlow.** I’ve built small AI models and GUIs, including a Tkinter app that predicts top-5 outputs with probabilities for any uploaded image.
  
<img align="right" alt="gif" src="https://user-images.githubusercontent.com/74038190/212747903-e9bdf048-2dc8-41f9-b973-0e72ff07bfba.gif" style="max-width: 50%; display: inline-block;" data-target="animated-image.originalImage"><br>
...
# 🚀 Projects so far:
## Anonymous Chat Platform - PopChats:
A public, anonymous, real-time chat system with no login and no persistent storage >>
- Temporary usernames with no account system
- Fully ephemeral chats (auto-deleted on server reset)
- Built by leveraging Render free-tier behavior (server sleep → memory reset)
- Zero data persistence — no logs, no storage
- Basic moderation and rate limiting to prevent spam/abuse
- Designed around system constraints to create a disposable chat environment
...
- [Check Out Page<br>(*Note: The server may take up to a minute to start due to free-tier hosting.*)](https://poll-app-hpf4.onrender.com/)
...
![](https://github-readme-streak-stats.herokuapp.com/?user=NILAY-KS07&theme=dark&hide_border=false)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=NILAY-KS07&theme=dark&hide_border=false&include_all_commits=true&count_private=true&layout=compact)
